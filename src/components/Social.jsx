...
const socialLinks = [
  ...
  { label: 'Email', href: `mailto:${personal.email}`, Icon: () => <Mail size={20} className="text-red-400" /> },
...
export default function Social() {
  ...
  return (
    <section id="social" className="pt-6 pb-2 sm:pt-8 sm:pb-3 relative z-10">
      <motion.div
      ...
      >
        ...
        {/* 1. Fully Centered Single Horizontal Social Row */}
        <div className="flex flex-wrap sm:flex-nowrap items-center justify-center gap-y-2.5 text-[13px] sm:text-[14px] w-full text-zinc-400 font-medium mb-6 sm:mb-7 select-none">
            ...
            return (
              <div key={item.label} className="inline-flex items-center">
                <a
                  ...
                  rel="noreferrer"
                  className="inline-flex items-center gap-1.5 text-zinc-400 hover:text-zinc-100 transition-colors duration-150 group px-1 py-0.5 whitespace-nowrap"
                >
                ...
                {idx < socialLinks.length - 1 && (
                  <span className="text-zinc-700 font-mono select-none px-1.5 sm:px-2 md:px-2.5">·</span>
                )}
              </div>
            )
          })}
        ...
        <div className="flex flex-col items-center text-center space-y-2 sm:space-y-2.5 max-w-[680px] mx-auto mb-6 sm:mb-7">
          <p className="text-[10px] font-mono text-zinc-500 uppercase tracking-widest select-none">
            GET IN TOUCH
          </p>

          <p className="text-[14px] sm:text-[14.5px] text-zinc-400 font-sans leading-relaxed">
            I'd love to hear from you.
          </p>

          {/* Clickable Email with Copy Feature */}
          <div className="pt-0.5 flex items-center justify-center gap-2.5 group">
            <a
              href={`mailto:${personal.email}`}
              className="text-[20px] sm:text-[26px] md:text-[30px] font-medium tracking-tight text-zinc-100 hover:text-[#ffdd00] transition-colors break-all"
            ...
            <button
              ...
              className="p-1.5 rounded-lg bg-zinc-900/80 hover:bg-zinc-800 border border-zinc-800 text-zinc-400 hover:text-zinc-200 transition-all cursor-pointer select-none shrink-0"
              title="Copy Email to Clipboard"
            >
              {copied ? (
                <span className="flex items-center gap-1 text-[11px] font-mono text-emerald-400 px-1">
                  <Check size={13} />
                  Copied
                </span>
              ) : (
        ...
        <div className="flex flex-col items-center text-center">
          <a
            ...
            className="inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-full bg-zinc-950/80 hover:bg-zinc-900 border border-zinc-800/80 hover:border-zinc-700 text-[11.5px] font-medium text-zinc-300 hover:text-white transition-all duration-200 shadow-sm"
          >
            <Heart size={12} className="text-rose-400/90 fill-rose-400/20" />
            <span>Sponsor</span>
          </a>
          <p className="text-[11px] text-zinc-500 font-sans mt-1.5 select-none">
            Support the things I build.
          </p>
        </div>

        {/* Centered Short Section Differentiating Divider (Standard across all sections) */}
